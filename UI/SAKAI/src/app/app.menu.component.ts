    ...
    template: `
        <div class="layout-menu-container">
            <ul class="layout-menu" role="menu" (keydown)="onKeydown($event)">
                ...
                <a href="https://hcs.ae/">
                    <img src="assets/layout/images/logo.png" alt="HCS" class="w-full mt-3"/>
                </a>
            </ul>
        </div>
    `
...
export class AppMenuComponent implements OnInit {
    ...
    constructor(private authService:AuthService,public app: AppComponent,private tabService:TabService){}
