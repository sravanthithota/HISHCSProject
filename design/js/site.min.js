!(function (e, t) {
    ...
    function a(e) {
        var t = {};
        return (
            de.each(e.match(ke) || [], function (e, n) {
                t[n] = !0;
            }),
            t
        );
    ...
    function p() {
        te.removeEventListener("DOMContentLoaded", p), e.removeEventListener("load", p), de.ready();
    }
    function f() {
    ...
    function y(e, t, n, i) {
        var r,
            ...
            u = (de.cssNumber[t] || ("px" !== c && +l)) && Re.exec(de.css(e, t));
        if (u && u[3] !== c) {
            (c = c || u[3]), (n = n || []), (u = +l || 1);
            do {
                (o = o || ".5"), (u /= o), de.style(e, t, u + c);
            } while (o !== (o = a() / l) && 1 !== o && --s);
        }
    ...
    function m(e) {
        var t,
            ...
            i = e.nodeName,
            r = Ue[i];
        return r || ((t = n.body.appendChild(n.createElement(i))), (r = de.css(t, "display")), t.parentNode.removeChild(t), "none" === r && (r = "block"), (Ue[i] = r), r);
    }
    function g(e, t) {
        for (var n, i, r = [], o = 0, s = e.length; o < s; o++)
            (i = e[o]).style &&
                ((n = i.style.display),
                t ? ("none" === n && ((r[o] = Ie.get(i, "display") || null), r[o] || (i.style.display = "")), "" === i.style.display && ze(i) && (r[o] = m(i))) : "none" !== n && ((r[o] = "none"), Ie.set(i, "display", n)));
    ...
    function b(e, t, n, i, r) {
        for (var o, s, a, l, c, u, p = t.createDocumentFragment(), f = [], h = 0, d = e.length; h < d; h++)
            if ((o = e[h]) || 0 === o)
                if ("object" === de.type(o)) de.merge(f, o.nodeType ? [o] : o);
                else if (Xe.test(o)) {
                    for (s = s || p.appendChild(t.createElement("div")), a = (Ve.exec(o) || ["", ""])[1].toLowerCase(), l = Ke[a] || Ke._default, s.innerHTML = l[1] + de.htmlPrefilter(o) + l[2], u = l[0]; u--; ) s = s.lastChild;
                    de.merge(f, s.childNodes), ((s = p.firstChild).textContent = "");
                } else f.push(t.createTextNode(o));
        for (p.textContent = "", h = 0; (o = f[h++]); )
            if (i && de.inArray(o, i) > -1) r && r.push(o);
            else if (((c = de.contains(o.ownerDocument, o)), (s = v(p.appendChild(o), "script")), c && x(s), n)) for (u = 0; (o = s[u++]); ) $e.test(o.type || "") && n.push(o);
        return p;
    }
    function w() {
        return !0;
    ...
    function A(e, t) {
        ...
        if (1 === t.nodeType) {
            if (Ie.hasData(e) && ((o = Ie.access(e)), (s = Ie.set(t, o)), (c = o.events))) {
                ...
                for (r in c) for (n = 0, i = c[r].length; n < i; n++) de.event.add(t, r, c[r][n]);
            }
            Le.hasData(e) && ((a = Le.access(e)), (l = de.extend({}, a)), Le.set(t, l));
        }
    }
    function k(e, t) {
    ...
    function O(e, t, i, r) {
        ...
        var o,
            ...
            d = t[0],
            y = de.isFunction(d);
        if (y || (f > 1 && "string" == typeof d && !fe.checkClone && tt.test(d)))
            return e.each(function (n) {
                var o = e.eq(n);
                y && (t[0] = d.call(this, n, o.html())), O(o, t, i, r);
            });
        if (f && ((o = b(t, e[0].ownerDocument, !1, e, r)), (s = o.firstChild), 1 === o.childNodes.length && (o = s), s || r)) {
            for (l = (a = de.map(v(o, "script"), j)).length; p < f; p++) (c = o), p !== h && ((c = de.clone(c, !0, !0)), l && de.merge(a, v(c, "script"))), i.call(e[p], c, p);
            if (l)
                for (u = a[a.length - 1].ownerDocument, de.map(a, S), p = 0; p < l; p++)
                    (c = a[p]), $e.test(c.type || "") && !Ie.access(c, "globalEval") && de.contains(u, c) && (c.src ? de._evalUrl && de._evalUrl(c.src) : n(c.textContent.replace(it, ""), u));
        }
        return e;
    }
    function N(e, t, n) {
        for (var i, r = t ? de.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || de.cleanData(v(i)), i.parentNode && (n && de.contains(i.ownerDocument, i) && x(v(i, "script")), i.parentNode.removeChild(i));
        return e;
    }
    function D(e, t, n) {
        var i,
        ...
        return (
            (n = n || st(e)) &&
                ("" !== (s = n.getPropertyValue(t) || n[t]) || de.contains(e.ownerDocument, e) || (s = de.style(e, t)),
    ...
    function L(e) {
        var t = de.cssProps[e];
        return t || (t = de.cssProps[e] = I(e) || e), t;
    }
    function H(e, t, n) {
        var i = Re.exec(t);
    ...
    function P(e, t, n, i, r) {
        ...
        for (o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2)
            "margin" === n && (s += de.css(e, n + Fe[o], !0, r)),
                i
                    ? ("content" === n && (s -= de.css(e, "padding" + Fe[o], !0, r)), "margin" !== n && (s -= de.css(e, "border" + Fe[o] + "Width", !0, r)))
                    : ((s += de.css(e, "padding" + Fe[o], !0, r)), "padding" !== n && (s += de.css(e, "border" + Fe[o] + "Width", !0, r)));
        return s;
    }
    function q(e, t, n) {
        var i,
            r = st(e),
            o = D(e, t, r),
            s = "border-box" === de.css(e, "boxSizing", !1, r);
        return ot.test(o)
            ? o
            : ((i = s && (fe.boxSizingReliable() || o === e.style[t])), "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]), (o = parseFloat(o) || 0) + P(e, t, n || (s ? "border" : "content"), i, r) + "px");
    }
    function R(e, t, n, i, r) {
        return new R.prototype.init(e, t, n, i, r);
    }
    function F() {
        dt && (!1 === te.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(F) : e.setTimeout(F, de.fx.interval), de.fx.tick());
    }
    function z() {
        return (
    ...
    function B(e, t) {
        var n, i, r, o, s;
        for (n in e)
            if (((i = de.camelCase(n)), (r = t[i]), (o = e[n]), Array.isArray(o) && ((r = o[1]), (o = e[n] = o[0])), n !== i && ((e[i] = o), delete e[n]), (s = de.cssHooks[i]) && "expand" in s)) {
    ...
    function V(e, t, n) {
        var i,
            ...
            l = function () {
                if (r) return !1;
                for (var t = ht || z(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), o = 0, s = c.tweens.length; o < s; o++) c.tweens[o].run(i);
            ...
            u = c.props;
        for (B(u, c.opts.specialEasing); o < s; o++) if ((i = V.prefilters[o].call(c, e, u, c.opts))) return de.isFunction(i.stop) && (de._queueHooks(c.elem, c.opts.queue).stop = de.proxy(i.stop, i)), i;
        return (
            de.map(u, U, c),
    ...
    (de.fn = de.prototype = {
        ...
        (de.extend = de.fn.extend = function () {
            var e,
                ...
                l = arguments.length,
                c = !1;
            for ("boolean" == typeof s && ((c = s), (s = arguments[a] || {}), a++), "object" == typeof s || de.isFunction(s) || (s = {}), a === l && ((s = this), a--); a < l; a++)
                        ...
                        (n = s[t]),
                            ...
                            s !== i &&
                                (c && i && (de.isPlainObject(i) || (r = Array.isArray(i)))
                                    ? (r ? ((r = !1), (o = n && Array.isArray(n) ? n : [])) : (o = n && de.isPlainObject(n) ? n : {}), (s[t] = de.extend(c, o, i)))
                                    : void 0 !== i && (s[t] = i));
            return s;
        }),
        de.extend({
            ...
            isPlainObject: function (e) {
                var t, n;
                return !(!e || "[object Object]" !== le.call(e) || ((t = ne(e)) && ("function" != typeof (n = ce.call(t, "constructor") && t.constructor) || ue.call(n) !== pe)));
            },
    ...
    var xe = (function (e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : R) !== N && O(t), (t = t || N), M)) {
                if (11 !== d && (l = ye.exec(e)))
                    if ((r = l[1])) {
                        if (9 === d) {
                ...
                if (b.qsa && !B[e + " "] && (!I || !I.test(e))) {
                    if (1 !== d) (h = t), (f = e);
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? (a = a.replace(xe, be)) : t.setAttribute("id", (a = q)), o = (u = T(e)).length; o--; ) u[o] = "#" + a + " " + p(u[o]);
            ...
            return t.first
                ...
                : function (t, n, l) {
                      ...
                      if (l) {
                          ...
                          for (; (t = t[i]); )
                              if (1 === t.nodeType || s)
                                  if (((p = t[q] || (t[q] = {})), (u = p[t.uniqueID] || (p[t.uniqueID] = {})), r && r === t.nodeName.toLowerCase())) t = t[i] || t;
                                  else {
                                      if ((c = u[o]) && c[0] === F && c[1] === a) return (f[2] = c[2]);
            ...
            return (
                ...
                i(function (i, s, a, l) {
                    var c,
                        ...
                        h = [],
                        m = s.length,
                        g = i || d(t || "*", a.nodeType ? [a] : a, []),
                        v = !e || (!i && t) ? g : y(g, f, e, a, l),
                        x = n ? (o || (i ? e : m || r) ? [] : s) : v;
                    if ((n && n(v, x, a, l), r)) for (c = y(x, h), r(c, [], a, l), u = c.length; u--; ) (p = c[u]) && (x[h[u]] = !(v[h[u]] = p));
                    if (i) {
                        if (o || e) {
                            if (o) {
                                for (c = [], u = x.length; u--; ) (p = x[u]) && c.push((v[u] = p));
                                o(null, (x = []), c, l);
                            }
                            for (u = x.length; u--; ) (p = x[u]) && (c = o ? J(i, p) : f[u]) > -1 && (i[c] = !(s[c] = p));
                        }
                    } else (x = y(x === s ? x.splice(m, x.length) : x)), o ? o(null, s, x, l) : Y.apply(s, x);
                })
            );
        }
        function g(e) {
            for (
                ...
                if ((n = w.relative[e[a].type])) u = [f(h(u), n)];
                    ...
                    if ((n = w.filter[e[a].type].apply(null, e[a].matches))[q]) {
                        ...
                        return m(a > 1 && h(u), a > 1 && p(e.slice(0, a - 1).concat({ value: " " === e[a - 2].type ? "*" : "" })).replace(oe, "$1"), n, a < i && g(e.slice(a, i)), i < r && g((e = e.slice(i))), i < r && p(e));
                    }
                    u.push(n);
                }
            return h(u);
            ...
            var r = n.length > 0,
                ...
                s = function (i, s, a, l, c) {
                    var u,
                        ...
                        _ = x.length;
                    for (c && (S = s === N || s || c); d !== _ && null != (u = x[d]); d++) {
                        if (o && u) {
                            for (p = 0, s || u.ownerDocument === N || (O(u), (a = !M)); (f = e[p++]); )
                                if (f(u, s || N, a)) {
                                    l.push(u);
                                    break;
                                }
                    ...
                    if (((h += d), r && d !== h)) {
                        for (p = 0; (f = n[p++]); ) f(m, g, s, a);
                        if (i) {
                            if (h > 0) for (; d--; ) m[d] || g[d] || (g[d] = X.call(l));
                            g = y(g);
                        }
                        Y.apply(l, g), c && !i && g.length > 0 && h + n.length > 1 && t.uniqueSort(l);
                    }
                    return c && ((F = b), (S = v)), m;
                };
            return r ? i(s) : s;
        ...
        try {
            Y.apply((K = G.call(R.childNodes)), R.childNodes), K[R.childNodes.length].nodeType;
        } catch (e) {
            Y = {
                apply: K.length
                    ? function (e, t) {
        ...
        (b = t.support = {}),
            ...
            (O = t.setDocument = function (e) {
                ...
                return i !== N && 9 === i.nodeType && i.documentElement
                    ? ((N = i),
                      (D = N.documentElement),
                      (M = !E(N)),
                      R !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)),
                      ...
                      (b.getElementsByClassName = de.test(N.getElementsByClassName)),
                      ...
                      (L = []),
                      (I = []),
                      (b.qsa = de.test(N.querySelectorAll)) &&
                          (r(function (e) {
                              (D.appendChild(e).innerHTML = "<a id='" + q + "'></a><select id='" + q + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                  ...
                                  e.querySelectorAll("[id~=" + q + "-]").length || I.push("~="),
                                  e.querySelectorAll(":checked").length || I.push(":checked"),
                                  e.querySelectorAll("a#" + q + "+*").length || I.push(".#.+[+~]");
                          }),
                          r(function (e) {
                      ...
                      (b.matchesSelector = de.test((H = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector))) &&
                          r(function (e) {
                              (b.disconnectedMatch = H.call(e, "*")), H.call(e, "[s!='']:x"), L.push("!=", ie);
                          }),
                      (I = I.length && new RegExp(I.join("|"))),
                      (L = L.length && new RegExp(L.join("|"))),
                      (t = de.test(D.compareDocumentPosition)),
                      (P =
                          t || de.test(D.contains)
                              ? function (e, t) {
                      ...
                      (V = t
                          ? function (e, t) {
                                ...
                                return (
                                    ...
                                    (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!b.sortDetached && t.compareDocumentPosition(e) === n)
                                        ? e === N || (e.ownerDocument === R && P(R, e))
                                            ? -1
                                            : t === N || (t.ownerDocument === R && P(R, t))
                                            ? 1
                                            : A
                                            ? J(A, e) - J(A, t)
                                            : 0
                          ...
                          : function (e, t) {
                                ...
                                var n,
                                    ...
                                    a = [e],
                                    l = [t];
                                if (!r || !o) return e === N ? -1 : t === N ? 1 : r ? -1 : o ? 1 : A ? J(A, e) - J(A, t) : 0;
                                if (r === o) return s(e, t);
            ...
            (t.matchesSelector = function (e, n) {
                if (((e.ownerDocument || e) !== N && O(e), (n = n.replace(le, "='$1']")), b.matchesSelector && M && !B[n + " "] && (!L || !L.test(n)) && (!I || !I.test(n))))
                    try {
                        var i = H.call(e, n);
            ...
            (t.contains = function (e, t) {
                return (e.ownerDocument || e) !== N && O(e), P(e, t);
            }),
            (t.attr = function (e, t) {
                (e.ownerDocument || e) !== N && O(e);
                var n = w.attrHandle[t.toLowerCase()],
                    i = n && $.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !M) : void 0;
            ...
            (t.uniqueSort = function (e) {
                var t,
                    ...
                    i = 0,
                    r = 0;
                if (((k = !b.detectDuplicates), (A = !b.sortStable && e.slice(0)), e.sort(V), k)) {
                        ...
                        return 1 === i && 0 === r
                            ...
                            : function (t, n, l) {
                                  ...
                                  if (m) {
                                      if (o) {
                                          for (; y; ) {
                                              for (f = t; (f = f[y]); ) if (a ? f.nodeName.toLowerCase() === g : 1 === f.nodeType) return !1;
                                      ...
                                      if (((d = [s ? m.firstChild : m.lastChild]), s && v)) {
                                          for (
                                              x = (h = (c = (u = (p = (f = m)[q] || (f[q] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] || [])[0] === F && c[1]) && c[2], f = h && m.childNodes[h];
                                              (f = (++h && f && f[y]) || (x = h = 0) || d.pop());
                                      ...
                                      } else if ((v && ((f = t), (p = f[q] || (f[q] = {})), (u = p[f.uniqueID] || (p[f.uniqueID] = {})), (c = u[e] || []), (h = c[0] === F && c[1]), (x = h)), !1 === x))
                                          for (
                                              ;
                                              (f = (++h && f && f[y]) || (x = h = 0) || d.pop()) &&
                                              ((a ? f.nodeName.toLowerCase() !== g : 1 !== f.nodeType) || !++x || (v && ((p = f[q] || (f[q] = {})), (u = p[f.uniqueID] || (p[f.uniqueID] = {})), (u[e] = [F, x])), f !== t));
        ...
        return (
            ...
            (C = t.compile = function (e, t) {
                var n,
                    ...
                    o = B[e + " "];
                if (!o) {
                    for (t || (t = T(e)), n = t.length; n--; ) (o = g(t[n]))[q] ? i.push(o) : r.push(o);
            ...
            (j = t.select = function (e, t, n, i) {
                ...
                if (((n = n || []), 1 === f.length)) {
                    if ((o = f[0] = f[0].slice(0)).length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && M && w.relative[o[1].type]) {
                    ...
                    for (r = pe.needsContext.test(e) ? 0 : o.length; r-- && ((s = o[r]), !w.relative[(a = s.type)]); )
                        if ((l = w.find[a]) && (i = l(s.matches[0].replace(ge, ve), (me.test(o[0].type) && c(t.parentNode)) || t))) {
                            if ((o.splice(r, 1), !(e = i.length && p(o)))) return Y.apply(n, i), n;
                            break;
                        }
                }
                return (u || C(e, f))(i, t, !M, n, !t || (me.test(e) && c(t.parentNode)) || t), n;
            }),
    ...
    (de.filter = function (e, t, n) {
        ...
        de.fn.extend({
            ...
            is: function (e) {
                return !!o(this, "string" == typeof e && _e.test(e) ? de(e) : e || [], !1).length;
            },
        });
    var Ce,
        je = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ((de.fn.init = function (e, t, n) {
        ...
        if (((n = n || Ce), "string" == typeof e)) {
            ...
            if (i[1]) {
                if (((t = t instanceof de ? t[0] : t), de.merge(this, de.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : te, !0)), Ee.test(i[1]) && de.isPlainObject(t)))
        ...
        de.each(
            ...
            function (e, t) {
                de.fn[e] = function (n, i) {
                    ...
                    return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = de.filter(i, r)), this.length > 1 && (Ae[e] || de.uniqueSort(r), Se.test(e) && r.reverse()), this.pushStack(r);
                };
            }
        );
    var ke = /[^\x20\t\r\n\f]+/g;
    (de.Callbacks = function (e) {
                ...
                remove: function () {
                    return (
                        de.each(arguments, function (e, t) {
                            for (var n; (n = de.inArray(t, o, n)) > -1; ) o.splice(n, 1), n <= l && l--;
                        }),
                        this
                    );
                },
        ...
        de.extend({
                ...
                var n = [
                    ...
                    r = {
                        ...
                        then: function (t, i, r) {
                                        ...
                                        p = function () {
                                            ...
                                            if (!(t < s)) {
                                                ...
                                                (p = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    de.isFunction(p)
                                                        ? r
                                                            ? p.call(e, o(s, n, l, r), o(s, n, c, r))
                                                            : (s++, p.call(e, o(s, n, l, r), o(s, n, c, r), o(s, n, l, n.notifyWith)))
                                                        : (i !== l && ((a = void 0), (u = [e])), (r || n.resolveWith)(a, u));
                                            }
                                        },
                                        f = r
                                            ? p
                                            : function () {
                                                  try {
                                                      ...
                                                      de.Deferred.exceptionHook && de.Deferred.exceptionHook(e, f.stackTrace), t + 1 >= s && (i !== c && ((a = void 0), (u = [e])), n.rejectWith(a, u));
                                                  }
                                              };
                            ...
                            return de
                                .Deferred(function (e) {
                                    n[0][3].add(o(0, e, de.isFunction(r) ? r : l, e.notifyWith)), n[1][3].add(o(0, e, de.isFunction(t) ? t : l)), n[2][3].add(o(0, e, de.isFunction(i) ? i : c));
                                })
                                .promise();
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (t <= 1 && (u(e, o.done(s(n)).resolve, o.reject, !t), "pending" === o.state() || de.isFunction(r[n] && r[n].then))) return o.then();
    ...
    (de.fn.ready = function (e) {
        ...
        "complete" === te.readyState || ("loading" !== te.readyState && !te.documentElement.doScroll) ? e.setTimeout(de.ready) : (te.addEventListener("DOMContentLoaded", p), e.addEventListener("load", p));
    ...
    (f.uid = 1),
        (f.prototype = {
            cache: function (e) {
                ...
                return t || ((t = {}), Me(e) && (e.nodeType ? (e[this.expando] = t) : Object.defineProperty(e, this.expando, { value: t, configurable: !0 }))), t;
            },
            set: function (e, t, n) {
                var i,
                    r = this.cache(e);
            ...
            remove: function (e, t) {
                ...
                if (void 0 !== i) {
                    if (void 0 !== t) {
                        Array.isArray(t) ? (t = t.map(de.camelCase)) : ((t = de.camelCase(t)), (t = t in i ? [t] : t.match(ke) || [])), (n = t.length);
                        for (; n--; ) delete i[t[n]];
                    }
    ...
    de.extend({
            ...
            data: function (e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && ((r = Le.get(o)), 1 === o.nodeType && !Ie.get(o, "hasDataAttrs"))) {
                        for (n = s.length; n--; ) s[n] && 0 === (i = s[n].name).indexOf("data-") && ((i = de.camelCase(i.slice(5))), d(o, i, r[i]));
        ...
        de.extend({
            queue: function (e, t, n) {
                var i;
                if (e) return (t = (t || "fx") + "queue"), (i = Ie.get(e, t)), n && (!i || Array.isArray(n) ? (i = Ie.access(e, t, de.makeArray(n))) : i.push(n)), i || [];
            },
            ...
            if (m)
                for (
                    ...
                    (a = Je.exec(t[c]) || []),
                        ...
                        (d = (a[2] || "").split(".").sort()),
                        h &&
                            ((p = de.event.special[h] || {}),
                            (h = (r ? p.delegateType : p.bindType) || h),
                            (p = de.event.special[h] || {}),
                            (u = de.extend({ type: h, origType: y, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && de.expr.match.needsContext.test(r), namespace: d.join(".") }, o)),
                            (f = l[h]) || ((f = l[h] = []), (f.delegateCount = 0), (p.setup && !1 !== p.setup.call(e, i, d, s)) || (e.addEventListener && e.addEventListener(h, s))),
        ...
        remove: function (e, t, n, i, r) {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(ke) || [""]).length; c--; )
                    if (((a = Je.exec(t[c]) || []), (h = y = a[1]), (d = (a[2] || "").split(".").sort()), h)) {
                        for (p = de.event.special[h] || {}, f = l[(h = (i ? p.delegateType : p.bindType) || h)] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--; )
                            (u = f[o]),
                                (!r && y !== u.origType) ||
                                    (n && n.guid !== u.guid) ||
                                    (a && !a.test(u.namespace)) ||
                                    (i && i !== u.selector && ("**" !== i || !u.selector)) ||
                                    (f.splice(o, 1), u.selector && f.delegateCount--, p.remove && p.remove.call(e, u));
                        s && !f.length && ((p.teardown && !1 !== p.teardown.call(e, d, m.handle)) || de.removeEvent(e, h, m.handle), delete l[h]);
                    } else for (h in l) de.event.remove(e, h + t[c], n, i, !0);
                de.isEmptyObject(l) && Ie.remove(e, "handle events");
            }
        },
        dispatch: function (e) {
            var t,
            ...
            if (((a.delegateTarget = this), !u.preDispatch || !1 !== u.preDispatch.call(this, a))) {
                for (s = de.event.handlers.call(this, a, c), t = 0; (r = s[t++]) && !a.isPropagationStopped(); )
                    for (a.currentTarget = r.elem, n = 0; (o = r.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        (a.rnamespace && !a.rnamespace.test(o.namespace)) ||
                            ((a.handleObj = o), (a.data = o.data), void 0 !== (i = ((de.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (o = [], s = {}, n = 0; n < l; n++) (i = t[n]), (r = i.selector + " "), void 0 === s[r] && (s[r] = i.needsContext ? de(r, this).index(c) > -1 : de.find(r, this, null, [c]).length), s[r] && o.push(i);
            ...
            return this instanceof de.Event
                ? (e && e.type
                      ? ((this.originalEvent = e),
                        (this.type = e.type),
                        (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? w : _),
    ...
    de.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(fe.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || de.isXMLDoc(e))) for (s = v(a), o = v(e), i = 0, r = o.length; i < r; i++) k(o[i], s[i]);
            if (t)
                if (n) for (o = o || v(e), s = s || v(a), i = 0, r = o.length; i < r; i++) A(o[i], s[i]);
                else A(e, a);
                ...
                return De(
                    ...
                    function (e) {
                        ...
                        if ("string" == typeof e && !et.test(e) && !Ke[(Ve.exec(e) || ["", ""])[1].toLowerCase()]) {
                            ...
                            try {
                                for (; n < i; n++) 1 === (t = this[n] || {}).nodeType && (de.cleanData(v(t, !1)), (t.innerHTML = e));
                                t = 0;
                            } catch (e) {}
                        }
    ...
    de.extend({
                ...
                return (
                    ...
                    void 0 === n
                        ? s && "get" in s && void 0 !== (r = s.get(e, !1, i))
                            ? r
                            : c[t]
                        : ("string" === (o = typeof n) && (r = Re.exec(n)) && r[1] && ((n = y(e, t, r)), (o = "number")),
                          void (
                              null != n &&
                              n === n &&
                              ("number" === o && (n += (r && r[3]) || (de.cssNumber[a] ? "" : "px")),
        ...
        css: function (e, t, n, i) {
            ...
            return (
                lt.test(t) || (t = L(a)),
                (s = de.cssHooks[t] || de.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)),
                void 0 === r && (r = D(e, t, i)),
        ...
        de.each(["height", "width"], function (e, t) {
            de.cssHooks[t] = {
                ...
                set: function (e, n, i) {
                    var r,
                        o = i && st(e),
                        s = i && P(e, t, i, "border-box" === de.css(e, "boxSizing", !1, o), o);
                    return s && (r = Re.exec(n)) && "px" !== (r[3] || "px") && ((e.style[t] = n), (n = de.css(e, t))), H(0, n, s);
                },
            };
        }),
        (de.cssHooks.marginLeft = M(fe.reliableMarginLeft, function (e, t) {
            if (t)
                return (
                ...
                return De(
                    ...
                    function (e, t, n) {
                        var i,
                            ...
                            s = 0;
                        if (Array.isArray(t)) {
                            for (i = st(e), r = t.length; s < r; s++) o[t[s]] = de.css(e, t[s], !1, i);
                            return o;
                        }
            ...
            function (e, t, n) {
                ...
                if ((l = !de.isEmptyObject(t)) || !de.isEmptyObject(h)) {
                    p &&
                        ...
                        "none" === (u = de.css(e, "display")) && (c ? (u = c) : (g([e], !0), (c = e.style.display || c), (u = de.css(e, "display")), g([e]))),
                    ...
                    for (i in h)
                        l ||
                            (m ? "hidden" in m && (y = m.hidden) : (m = Ie.access(e, "fxshow", { display: c })),
                            o && (m.hidden = !y),
                            y && g([e], !0),
                            f.done(function () {
                                y || g([e]), Ie.remove(e, "fxshow");
                                for (i in h) de.style(e, i, h[i]);
                            })),
                            (l = U(y ? m[i] : 0, i, f)),
                            i in m || ((m[i] = l.start), y && ((l.end = l.start), (l.start = 0)));
                }
            },
        ],
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? de.prop(e, t, n)
                        : ((1 === o && de.isXMLDoc(e)) || (r = de.attrHooks[t.toLowerCase()] || (de.expr.match.bool.test(t) ? gt : void 0)),
                          void 0 !== n
                              ? null === n
        ...
        de.fn.extend({
            ...
            toggleClass: function (e, t) {
                ...
                return "boolean" == typeof t && "string" === n
                    ...
                    : this.each(function () {
                          var t, i, r, o;
                          if ("string" === n) for (i = 0, r = de(this), o = e.match(ke) || []; (t = o[i++]); ) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                          else (void 0 !== e && "boolean" !== n) || ((t = K(this)) && Ie.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Ie.get(this, "__className__") || ""));
                      });
            },
            hasClass: function (e) {
                var t,
                    n,
                    i = 0;
                for (t = " " + e + " "; (n = this[i++]); ) if (1 === n.nodeType && (" " + $(K(n)) + " ").indexOf(t) > -1) return !0;
                return !1;
            },
        });
    var wt = /\r/g;
    de.fn.extend({
        val: function (e) {
            ...
            return arguments.length
                ...
                : r
                ? (t = de.valHooks[r.type] || de.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value"))
                    ? n
    ...
    de.extend(de.event, {
        trigger: function (t, n, i, r) {
            ...
            if (
                ...
                if (!r && !p.noBubble && !de.isWindow(i)) {
                    for (l = p.delegateType || h, _t.test(l + h) || (s = s.parentNode); s; s = s.parentNode) f.push(s), (a = s);
                    a === (i.ownerDocument || te) && f.push(a.defaultView || a.parentWindow || e);
                }
                for (o = 0; (s = f[o++]) && !t.isPropagationStopped(); )
                    (t.type = o > 1 ? l : p.bindType || h),
                        (u = (Ie.get(s, "events") || {})[t.type] && Ie.get(s, "handle")) && u.apply(s, n),
                        (u = c && s[c]) && u.apply && Me(s) && ((t.result = u.apply(s, n)), !1 === t.result && t.preventDefault());
                return (
                    (t.type = h),
                    r ||
                        ...
                        !Me(i) ||
                        (c && de.isFunction(i[h]) && !de.isWindow(i) && ((a = i[c]) && (i[c] = null), (de.event.triggered = h), i[h](), (de.event.triggered = void 0), a && (i[c] = a))),
                    t.result
                );
            }
        },
        ...
        de.fn.extend({
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    .filter(function () {
                        var e = this.type;
                        return this.name && !de(this).is(":disabled") && kt.test(this.nodeName) && !At.test(e) && (this.checked || !Be.test(e));
                    })
                    .map(function (e, t) {
                        var n = de(this).val();
                        return null == n
            ...
            ajax: function (t, n) {
                function i(t, n, i, a) {
                    ...
                    u ||
                        ...
                        (b = Z(d, b, E, c)),
                        c
                            ? (d.ifModified && ((w = E.getResponseHeader("Last-Modified")) && (de.lastModified[o] = w), (w = E.getResponseHeader("etag")) && (de.etag[o] = w)),
                              204 === t || "HEAD" === d.type ? (_ = "nocontent") : 304 === t ? (_ = "notmodified") : ((_ = b.state), (f = b.data), (h = b.error), (c = !h)))
                            : ((h = _), (!t && _) || ((_ = "error"), t < 0 && (t = 0))),
                        (E.status = t),
                        (E.statusText = (n || _) + ""),
                        c ? g.resolveWith(y, [f, _, E]) : g.rejectWith(y, [E, _, h]),
                        E.statusCode(x),
                        (x = void 0),
                        p && m.trigger(c ? "ajaxSuccess" : "ajaxError", [E, d, c ? f : h]),
                        v.fireWith(y, [E, _]),
                        p && (m.trigger("ajaxComplete", [E, d]), --de.active || de.event.trigger("ajaxStop")));
                }
                ...
                var r,
                    ...
                    d = de.ajaxSetup({}, n),
                    y = d.context || d,
                    m = d.context && (y.nodeType || y.jquery) ? de(y) : de.event,
                    g = de.Deferred(),
                ...
                if (
                    (g.promise(E),
                    (d.url = ((t || d.url || Et.href) + "").replace(Ht, Et.protocol + "//")),
                    (d.type = n.method || n.type || d.method || d.type),
                    (d.dataTypes = (d.dataType || "*").toLowerCase().match(ke) || [""]),
                    null == d.crossDomain)
                ) {
                    c = te.createElement("a");
                    try {
                        (c.href = d.url), (c.href = c.href), (d.crossDomain = Ft.protocol + "//" + Ft.host != c.protocol + "//" + c.host);
                    } catch (e) {
                        d.crossDomain = !0;
                    }
                }
                if ((d.data && d.processData && "string" != typeof d.data && (d.data = de.param(d.data, d.traditional)), Y(Pt, d, n, E), u)) return E;
                (p = de.event && d.global) && 0 == de.active++ && de.event.trigger("ajaxStart"),
                    ...
                    d.hasContent
                        ...
                        : ((h = d.url.slice(o.length)), d.data && ((o += (Ct.test(o) ? "&" : "?") + d.data), delete d.data), !1 === d.cache && ((o = o.replace(Dt, "$1")), (h = (Ct.test(o) ? "&" : "?") + "_=" + Tt++ + h)), (d.url = o + h)),
                    d.ifModified && (de.lastModified[o] && E.setRequestHeader("If-Modified-Since", de.lastModified[o]), de.etag[o] && E.setRequestHeader("If-None-Match", de.etag[o])),
                ...
                if (d.beforeSend && (!1 === d.beforeSend.call(y, E, d) || u)) return E.abort();
                if (((_ = "abort"), v.add(d.complete), E.done(d.success), E.fail(d.error), (r = Y(qt, d, n, E)))) {
                    if (((E.readyState = 1), p && m.trigger("ajaxSend", [E, d]), u)) return E;
                    d.async &&
                        d.timeout > 0 &&
                            ...
                            return function () {
                                n &&
                                    ...
                                    "abort" === e
                                        ...
                                        : o(zt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
                            };
                        }),
                            (a.onload = n()),
                            (i = a.onerror = n("error")),
    ...
    de.ajaxSetup({
        ...
        de.ajaxPrefilter("json jsonp", function (t, n, i) {
            ...
            if (a || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    a ? (t[a] = t[a].replace(Bt, "$1" + r)) : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
                    ...
                    i.always(function () {
                        void 0 === o ? de(e).removeProp(r) : (e[r] = o), t[r] && ((t.jsonpCallback = n.jsonpCallback), Ut.push(r)), s && de.isFunction(o) && o(s[0]), (s = o = void 0);
                    }),
                    "script"
                );
        }),
        ...
        (de.parseHTML = function (e, t, n) {
            ...
            return (
                ...
                (r = Ee.exec(e)),
                (o = !n && []),
                r ? [t.createElement(r[1])] : ((r = b([e], t, o)), o && o.length && de(o).remove(), de.merge([], r.childNodes))
            );
        }),
        ...
        (de.offset = {
            setOffset: function (e, t, n) {
                ...
                "static" === c && (e.style.position = "relative"),
                    ...
                    (o = de.css(e, "top")),
                    (l = de.css(e, "left")),
                    ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1 ? ((i = u.position()), (s = i.top), (r = i.left)) : ((s = parseFloat(o) || 0), (r = parseFloat(l) || 0)),
        ...
        de.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (e, t) {
            ...
            de.fn[e] = function (i) {
                return De(
                    ...
                    function (e, i, r) {
                        var o;
                        return de.isWindow(e) ? (o = e) : 9 === e.nodeType && (o = e.defaultView), void 0 === r ? (o ? o[t] : e[i]) : void (o ? o.scrollTo(n ? o.pageXOffset : r, n ? r : o.pageYOffset) : (e[i] = r));
                    },
                    e,
                    i,
                    arguments.length
        ...
        de.each(["top", "left"], function (e, t) {
            de.cssHooks[t] = M(fe.pixelPosition, function (e, n) {
    ...
    return (
        (de.noConflict = function (t) {
            return e.$ === de && (e.$ = $t), t && e.jQuery === de && (e.jQuery = Vt), de;
        }),
        t || (e.jQuery = e.$ = de),
        de
    );
    ...
    (function (e, t) {
        ...
        function a(e, t) {
            ...
            var p = s(e);
            return p.host ? a(p.host, t) : a(e, s(t).host);
        }
        function l(e) {
        ...
        function p(e, t, n, i) {
            return K(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], te() ? n["offset" + e] + i["margin" + ("Height" === e ? "Top" : "Left")] + i["margin" + ("Height" === e ? "Bottom" : "Right")] : 0);
        }
        function f() {
            var e = window.document.body,
                t = window.document.documentElement,
                n = te() && window.getComputedStyle(t);
            return { height: p("Height", e, t, n), width: p("Width", e, t, n) };
        }
        function h(e) {
            return oe({}, e, { right: e.left + e.width, bottom: e.top + e.height });
        }
        function d(e) {
            var n = {};
            if (te())
            ...
            if (p || d) {
                var y = t(e);
                (p -= u(y, "x")), (d -= u(y, "y")), (o.width -= p), (o.height -= d);
            }
            return h(o);
        }
        function y(e, n) {
            var r = te(),
                ...
                l = i(e),
                u = t(n),
                p = +u.borderTopWidth.split("px")[0],
                f = +u.borderLeftWidth.split("px")[0],
                y = h({ top: s.top - a.top - p, left: s.left - a.left - f, width: s.width, height: s.height });
            if (((y.marginTop = 0), (y.marginLeft = 0), !r && o)) {
                var m = +u.marginTop.split("px")[0],
                    g = +u.marginLeft.split("px")[0];
                (y.top -= p - m), (y.bottom -= p - m), (y.left -= f - g), (y.right -= f - g), (y.marginTop = m), (y.marginLeft = g);
            }
            return (r ? n.contains(l) : n === l && "BODY" !== l.nodeName) && (y = c(y, n)), y;
        }
        function m(e) {
            var t = window.document.documentElement,
                n = y(e, t),
                i = K(t.clientWidth, window.innerWidth || 0),
                r = K(t.clientHeight, window.innerHeight || 0),
                o = l(t),
                s = l(t, "left");
        ...
        function g(e) {
            var i = e.nodeName;
            return "BODY" !== i && "HTML" !== i && ("fixed" === t(e, "position") || g(n(e)));
        }
        function v(e, t, r, o) {
            var s = { top: 0, left: 0 },
                l = a(e, t);
        ...
        function b(e, t, n, i, r) {
            ...
            var s = v(n, i, o, r),
                ...
                l = Object.keys(a)
                    .map(function (e) {
                        return oe({ key: e }, a[e], { area: x(a[e]) });
                    })
                    .sort(function (e, t) {
        ...
        function S(t, n, i) {
            return (
                (void 0 === i ? t : t.slice(0, j(t, "name", i))).forEach(function (t) {
        ...
        function N() {
            return (
                ...
                k(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"), (this.popper.style.left = ""), (this.popper.style.position = ""), (this.popper.style.top = ""), (this.popper.style[O("transform")] = "")),
        ...
        function D(e, t, n, r) {
            var o = "BODY" === e.nodeName,
                s = o ? window : e;
            s.addEventListener(t, n, { passive: !0 }), o || D(i(s.parentNode), t, n, r), r.push(s);
        }
        function M(e, t, n, r) {
        ...
        function U(e, t, n, i) {
            ...
            if ("vh" === s || "vw" === s) {
                return (("vh" === s ? K(document.documentElement.clientHeight, window.innerHeight || 0) : K(document.documentElement.clientWidth, window.innerWidth || 0)) / 100) * o;
            }
            return o;
        }
        function B(e, t, n, i) {
        ...
        for (var V = Math.min, $ = Math.floor, K = Math.max, X = ["native code", "[object MutationObserverConstructor]"], Q = "undefined" != typeof window, Y = ["Edge", "Trident", "Firefox"], G = 0, J = 0; J < Y.length; J += 1)
            if (Q && 0 <= navigator.userAgent.indexOf(Y[J])) {
                G = 1;
                break;
            }
        var Z,
                ...
                function t(n, i) {
                    ...
                    ne(this, t),
                        ...
                        (this.modifiers = Object.keys(this.options.modifiers)
                            .map(function (e) {
                                return oe({ name: e }, r.options.modifiers[e]);
                            })
                            .sort(function (e, t) {
                ...
                modifiers: {
                        ...
                        fn: function (e) {
                            ...
                            if (i) {
                                var r = e.offsets,
                                    ...
                                    l = a ? "left" : "top",
                                    c = a ? "width" : "height",
                                    u = { start: re({}, l, o[l]), end: re({}, l, o[l] + o[c] - s[c]) };
                        ...
                        fn: function (e, t) {
                            ...
                            var o = t.priority,
                                ...
                                a = {
                                    primary: function (e) {
                                        var n = s[e];
                                        return s[e] < i[e] && !t.escapeWithReference && (n = K(s[e], i[e])), re({}, e, n);
                                    },
                    ...
                    arrow: {
                        ...
                        fn: function (e, n) {
                            ...
                            var r = e.placement.split("-")[0],
                                ...
                                d = l ? "bottom" : "right",
                                y = _(i)[c];
                            a[d] - y < s[p] && (e.offsets.popper[p] -= s[p] - (a[d] - y)), a[p] + y > s[d] && (e.offsets.popper[p] += a[p] + y - s[d]);
                            var m = a[p] + a[c] / 2 - y / 2,
                                g = t(e.instance.popper, "margin" + u).replace("px", ""),
                                v = m - h(e.offsets.popper)[p] - g;
                            return (v = K(V(s[c] - y, v), 0)), (e.arrowElement = i), (e.offsets.arrow = {}), (e.offsets.arrow[p] = Math.round(v)), (e.offsets.arrow[f] = ""), e;
                        },
                        element: "[x-arrow]",
                    },
                    flip: {
                            ...
                            return (
                                s.forEach(function (a, l) {
                                    ...
                                    var c = e.offsets.popper,
                                        ...
                                        g = ("left" === i && h) || ("right" === i && d) || ("top" === i && y) || ("bottom" === i && m),
                                        v = -1 !== ["top", "bottom"].indexOf(i),
                                        x = !!t.flipVariations && ((v && "start" === o && h) || (v && "end" === o && d) || (!v && "start" === o && y) || (!v && "end" === o && m));
                                    (f || g || x) &&
                                        ((e.flipped = !0),
                                        (f || g) && (i = s[l + 1]),
                                        x && (o = z(o)),
                    ...
                    inner: {
                        ...
                        fn: function (e) {
                            ...
                            return (r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0)), (e.placement = E(t)), (e.offsets.popper = h(r)), e;
                        },
                    },
                    hide: {
                        order: 800,
                    ...
                    computeStyle: {
                        ...
                        fn: function (e, t) {
                            ...
                            var a,
                                ...
                                u = d(r(e.instance.popper)),
                                p = { position: o.position },
                                f = { left: $(o.left), top: $(o.top), bottom: $(o.bottom), right: $(o.right) },
                                h = "bottom" === n ? "top" : "bottom",
                                y = "right" === i ? "left" : "right",
                                m = O("transform");
                            if (((l = "bottom" == h ? -u.height + f.bottom : f.top), (a = "right" == y ? -u.width + f.right : f.left), c && m))
                                (p[m] = "translate3d(" + a + "px, " + l + "px, 0)"), (p[h] = 0), (p[y] = 0), (p.willChange = "transform");
                            else {
                                var g = "bottom" == h ? -1 : 1,
                                    v = "right" == y ? -1 : 1;
                                (p[h] = l * g), (p[y] = a * v), (p.willChange = h + ", " + y);
                            }
                            var x = { "x-placement": e.placement };
                            return (e.attributes = oe({}, x, e.attributes)), (e.styles = oe({}, p, e.styles)), (e.arrowStyles = oe({}, e.offsets.arrow, e.arrowStyles)), e;
                        },
                        gpuAcceleration: !0,
                        x: "bottom",
                        y: "right",
                    ...
                    applyStyle: {
                        ...
                        enabled: !0,
                        fn: function (e) {
                            return q(e.instance.popper, e.styles), R(e.instance.popper, e.attributes), e.arrowElement && Object.keys(e.arrowStyles).length && q(e.arrowElement, e.arrowStyles), e;
                        },
    ...
    (function (e, t) {
                ...
                !(function (e, n) {
                    ...
                    a.forEach(function (e) {
                        (function (e, t) {
                            ...
                            if (-1 !== t.indexOf(n)) return -1 === Ae.indexOf(n) || Boolean(e.nodeValue.match(Oe) || e.nodeValue.match(Ne));
                            for (
        ...
        var c = "alert",
            ...
            p = "." + u,
            f = t.fn[c],
            h = { CLOSE: "close" + p, CLOSED: "closed" + p, CLICK_DATA_API: "click" + p + ".data-api" },
            d = (function () {
                function e(e) {
                    this._element = e;
                }
        ...
        var y = "button",
            ...
            _ = ".btn",
            E = { CLICK_DATA_API: "click" + g + v, FOCUS_BLUR_DATA_API: "focus" + g + v + " blur" + g + v },
            T = (function () {
                function e(e) {
                    this._element = e;
                }
        ...
        t(document)
            .on(E.CLICK_DATA_API, w, function (e) {
                e.preventDefault();
                var n = e.target;
                t(n).hasClass("btn") || (n = t(n).closest(_)), T._jQueryInterface.call(t(n), "toggle");
            })
            .on(E.FOCUS_BLUR_DATA_API, w, function (e) {
                var n = t(e.target).closest(_)[0];
                t(n).toggleClass("focus", /^focus(in)?$/.test(e.type));
            }),
            (t.fn[y] = T._jQueryInterface),
            (t.fn[y].Constructor = T),
            (t.fn[y].noConflict = function () {
                return (t.fn[y] = x), T._jQueryInterface;
            });
        var C = "carousel",
            j = "bs.carousel",
            S = "." + j,
            ...
            R = (function () {
                ...
                return (
                    ...
                    (n._getConfig = function (e) {
                        return (e = o({}, O, e)), l.typeCheckConfig(C, e, N), e;
                    }),
                    ...
                    (n._slide = function (e, n) {
                        ...
                        if (((o = e === D ? ((i = "carousel-item-left"), (r = "carousel-item-next"), "left") : ((i = "carousel-item-right"), (r = "carousel-item-prev"), "right")), u && t(u).hasClass(L))) this._isSliding = !1;
                            ...
                            var h = t.Event(I.SLID, { relatedTarget: u, direction: o, from: c, to: p });
                            ...
                            } else t(a).removeClass(L), t(u).addClass(L), (this._isSliding = !1), t(this._element).trigger(h);
                            f && this.cycle();
                        }
                    }),
                    (e._jQueryInterface = function (n) {
        ...
        t(document).on(I.CLICK_DATA_API, "[data-slide], [data-slide-to]", R._dataApiClickHandler),
            ...
            (t.fn[C].noConflict = function () {
                return (t.fn[C] = k), R._jQueryInterface;
            });
        var F = "collapse",
            z = "bs.collapse",
            W = "." + z,
            ...
            $ = { SHOW: "show" + W, SHOWN: "shown" + W, HIDE: "hide" + W, HIDDEN: "hidden" + W, CLICK_DATA_API: "click" + W + ".data-api" },
            K = "show",
            X = "collapse",
            Q = "collapsing",
            Y = "collapsed",
            ...
            J = (function () {
                ...
                return (
                        ...
                        if (
                            !(
                                ...
                                (this._parent &&
                                    ...
                                    (n = null),
                                n && (i = t(n).not(this._selector).data(z)) && i._isTransitioning)
                            )
                        ) {
                            var o = t.Event($.SHOW);
                            if ((t(this._element).trigger(o), !o.isDefaultPrevented())) {
                                ...
                                t(this._element).removeClass(X).addClass(Q), (this._element.style[s] = 0), this._triggerArray.length && t(this._triggerArray).removeClass(Y).attr("aria-expanded", !0), this.setTransitioning(!0);
                                var a = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                                    c = l.getTransitionDurationFromElement(this._element);
                                t(this._element)
                                    .one(l.TRANSITION_END, function () {
                                        t(r._element).removeClass(Q).addClass(X).addClass(K), (r._element.style[s] = ""), r.setTransitioning(!1), t(r._element).trigger($.SHOWN);
                                    })
                    ...
                    (n.hide = function () {
                        ...
                        if (!this._isTransitioning && t(this._element).hasClass(K)) {
                            ...
                            if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                                ...
                                (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px"), l.reflow(this._element), t(this._element).addClass(Q).removeClass(X).removeClass(K);
                                var r = this._triggerArray.length;
                                if (0 < r)
                                    for (var o = 0; o < r; o++) {
                                        var s = this._triggerArray[o],
                                            a = l.getSelectorFromElement(s);
                                        null !== a && (t([].slice.call(document.querySelectorAll(a))).hasClass(K) || t(s).addClass(Y).attr("aria-expanded", !1));
                                    }
                                this.setTransitioning(!0), (this._element.style[i] = "");
                                var c = l.getTransitionDurationFromElement(this._element);
                                t(this._element)
                                    .one(l.TRANSITION_END, function () {
                                        e.setTransitioning(!1), t(e._element).removeClass(Q).addClass(X).trigger($.HIDDEN);
                                    })
                                    .emulateTransitionEnd(c);
                            }
                        }
                    ...
                    (n._getConfig = function (e) {
                        return ((e = o({}, B, e)).toggle = Boolean(e.toggle)), l.typeCheckConfig(F, e, V), e;
                    }),
                    ...
                    (e._jQueryInterface = function (n) {
                        return this.each(function () {
                            ...
                            if ((!r && s.toggle && /show|hide/.test(n) && (s.toggle = !1), r || ((r = new e(this, s)), i.data(z, r)), "string" == typeof n)) {
        ...
        t(document).on($.CLICK_DATA_API, G, function (e) {
            ...
            (t.fn[F].noConflict = function () {
                return (t.fn[F] = U), J._jQueryInterface;
            });
        var Z = "dropdown",
            ee = "bs.dropdown",
            te = "." + ee,
            ...
            ue = ".dropdown-menu",
            pe = { offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic" },
                ...
                return (
                    ...
                    (i.show = function () {
                        if (!(this._element.disabled || t(this._element).hasClass(se) || t(this._menu).hasClass(ae))) {
                            ...
                            t(r).trigger(i), i.isDefaultPrevented() || (t(this._menu).toggleClass(ae), t(r).toggleClass(ae).trigger(t.Event(oe.SHOWN, n)));
                        }
                    }),
                    (i.hide = function () {
                        if (!this._element.disabled && !t(this._element).hasClass(se) && t(this._menu).hasClass(ae)) {
                            var n = { relatedTarget: this._element },
                                i = t.Event(oe.HIDE, n),
                                r = e._getParentFromElement(this._element);
                            t(r).trigger(i), i.isDefaultPrevented() || (t(this._menu).toggleClass(ae), t(r).toggleClass(ae).trigger(t.Event(oe.HIDDEN, n)));
                        }
                    }),
                    (i.dispose = function () {
                    ...
                    (i._getConfig = function (e) {
                        return (e = o({}, this.constructor.Default, t(this._element).data(), e)), l.typeCheckConfig(Z, e, this.constructor.DefaultType), e;
                    }),
                    ...
                    (i._getPlacement = function () {
                        ...
                        return (
                            e.hasClass("dropup")
                                ? ((n = "top-start"), t(this._menu).hasClass(le) && (n = "top-end"))
                                : e.hasClass("dropright")
                                ? (n = "right-start")
                                : e.hasClass("dropleft")
                                ? (n = "left-start")
                                : t(this._menu).hasClass(le) && (n = "bottom-end"),
                            n
                        );
                    }),
                    ...
                    (e._dataApiKeydownHandler = function (n) {
                        if (
                            (/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || (27 !== n.which && ((40 !== n.which && 38 !== n.which) || t(n.target).closest(ue).length))) : re.test(n.which)) &&
        ...
        t(document)
            ...
            .on(oe.KEYDOWN_DATA_API, ue, he._dataApiKeydownHandler)
            .on(oe.CLICK_DATA_API + " " + oe.KEYUP_DATA_API, he._clearMenus)
            .on(oe.CLICK_DATA_API, ce, function (e) {
        ...
        var de = "modal",
            ...
            Se = (function () {
                ...
                return (
                    ...
                    (n._getConfig = function (e) {
                        return (e = o({}, ve, e)), l.typeCheckConfig(de, e, xe), e;
                    }),
                    (n._showElement = function (e) {
                        ...
                        var r = t.Event(be.SHOWN, { relatedTarget: e }),
                            o = function () {
                    ...
                    (n._setScrollbar = function () {
                        ...
                        if (this._isBodyOverflowing) {
                            var n = [].slice.call(document.querySelectorAll(Ce)),
                                i = [].slice.call(document.querySelectorAll(je));
                    ...
                    (e._jQueryInterface = function (n, i) {
                        return this.each(function () {
                            var r = t(this).data(ye),
                                s = o({}, ve, t(this).data(), "object" == typeof n && n ? n : {});
                            if ((r || ((r = new e(this, s)), t(this).data(ye, r)), "string" == typeof n)) {
                                if (void 0 === r[n]) throw new TypeError('No method named "' + n + '"');
                                r[n](i);
        ...
        t(document).on(be.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
            ...
            var s = t(n).data(ye) ? "toggle" : o({}, t(n).data(), t(this).data());
            ("A" !== this.tagName && "AREA" !== this.tagName) || e.preventDefault();
            var a = t(n).one(be.SHOW, function (e) {
                e.isDefaultPrevented() ||
                    a.one(be.HIDDEN, function () {
            ...
            (t.fn[de].noConflict = function () {
                return (t.fn[de] = ge), Se._jQueryInterface;
            });
            ...
            Xe = (function () {
                ...
                return (
                    ...
                    (i.show = function () {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            t(s).data(this.constructor.DATA_KEY, this),
                                t.contains(this.element.ownerDocument.documentElement, this.tip) || t(s).appendTo(p),
                    ...
                    (i.setContent = function () {
                        ...
                        this.setElementContent(t(e.querySelectorAll(".tooltip-inner")), this.getTitle()), t(e).removeClass(Be + " " + Ve);
                    }),
                    (i.setElementContent = function (e, n) {
                        "object" != typeof n || (!n.nodeType && !n.jquery)
                            ? this.config.html
                                ? (this.config.sanitize && (n = s(n, this.config.whiteList, this.config.sanitizeFn)), e.html(n))
                                : e.text(n)
                            : this.config.html
                    ...
                    (i._enter = function (e, n) {
                        ...
                        (n = n || t(e.currentTarget).data(i)) || ((n = new this.constructor(e.currentTarget, this._getDelegateConfig())), t(e.currentTarget).data(i, n)),
                            e && (n._activeTrigger["focusin" === e.type ? Ke : $e] = !0),
                            t(n.getTipElement()).hasClass(Ve) || n._hoverState === We
                                ? (n._hoverState = We)
                    ...
                    (i._leave = function (e, n) {
                        var i = this.constructor.DATA_KEY;
                        (n = n || t(e.currentTarget).data(i)) || ((n = new this.constructor(e.currentTarget, this._getDelegateConfig())), t(e.currentTarget).data(i, n)),
                            e && (n._activeTrigger["focusout" === e.type ? Ke : $e] = !1),
                    ...
                    (i._getConfig = function (e) {
                        ...
                        return (
                            ...
                            "number" == typeof (e = o({}, this.constructor.Default, n, "object" == typeof e && e ? e : {})).delay && (e.delay = { show: e.delay, hide: e.delay }),
                            "number" == typeof e.title && (e.title = e.title.toString()),
                            "number" == typeof e.content && (e.content = e.content.toString()),
                            l.typeCheckConfig(De, e, this.constructor.DefaultType),
                    ...
                    (e._jQueryInterface = function (n) {
                        return this.each(function () {
                            var i = t(this).data(Me),
                                r = "object" == typeof n && n;
                            if ((i || !/dispose|hide/.test(n)) && (i || ((i = new e(this, r)), t(this).data(Me, i)), "string" == typeof n)) {
                                if (void 0 === i[n]) throw new TypeError('No method named "' + n + '"');
                                i[n]();
                            }
                        });
        ...
        (t.fn[De] = Xe._jQueryInterface),
            (t.fn[De].Constructor = Xe),
            (t.fn[De].noConflict = function () {
                return (t.fn[De] = Le), Xe._jQueryInterface;
            });
        var Qe = "popover",
            Ye = "bs.popover",
            Ge = "." + Ye,
            ...
            tt = o({}, Xe.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
            nt = o({}, Xe.DefaultType, { content: "(string|element|function)" }),
            it = {
                HIDE: "hide" + Ge,
                HIDDEN: "hidden" + Ge,
                SHOW: "show" + Ge,
                ...
                return (
                    ...
                    (n._jQueryInterface = function (e) {
                        return this.each(function () {
                            ...
                            if ((i || !/dispose|hide/.test(e)) && (i || ((i = new n(this, r)), t(this).data(Ye, i)), "string" == typeof e)) {
        ...
        (t.fn[Qe] = rt._jQueryInterface),
            ...
            (t.fn[Qe].noConflict = function () {
                return (t.fn[Qe] = Je), rt._jQueryInterface;
            });
        var ot = "scrollspy",
            st = "bs.scrollspy",
            at = "." + st,
            ...
            pt = { ACTIVATE: "activate" + at, SCROLL: "scroll" + at, LOAD_DATA_API: "load" + at + ".data-api" },
            ft = "active",
            ht = ".nav, .list-group",
            dt = ".nav-link",
            yt = ".list-group-item",
            ...
            vt = (function () {
                function e(e, n) {
                    ...
                    (this._element = e),
                        ...
                        (this._selector = this._config.target + " " + dt + "," + this._config.target + " " + yt + "," + this._config.target + " " + mt),
                        (this._offsets = []),
                        (this._targets = []),
                ...
                return (
                    ...
                    (n._getConfig = function (e) {
                        if ("string" != typeof (e = o({}, ct, "object" == typeof e && e ? e : {})).target) {
                            ...
                            n || ((n = l.getUID(ot)), t(e.target).attr("id", n)), (e.target = "#" + n);
                        }
                        return l.typeCheckConfig(ot, e, ut), e;
                    }),
        ...
        t(window).on(pt.LOAD_DATA_API, function () {
            ...
            (t.fn[ot].noConflict = function () {
                return (t.fn[ot] = lt), vt._jQueryInterface;
            });
        var xt = "bs.tab",
            bt = "." + xt,
            wt = t.fn.tab,
                ...
                return (
                    (n.show = function () {
                        ...
                        if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(Et)) || t(this._element).hasClass("disabled"))) {
                            ...
                            var a = t.Event(_t.HIDE, { relatedTarget: this._element }),
                            ...
                            if ((i && t(i).trigger(a), t(this._element).trigger(c), !c.isDefaultPrevented() && !a.isDefaultPrevented())) {
                                ...
                                var u = function () {
                                    var n = t.Event(_t.HIDDEN, { relatedTarget: e._element }),
                                        r = t.Event(_t.SHOWN, { relatedTarget: i });
                    ...
                    (e._jQueryInterface = function (n) {
                        return this.each(function () {
                            var i = t(this),
                                r = i.data(xt);
                            if ((r || ((r = new e(this)), i.data(xt, r)), "string" == typeof n)) {
                                if (void 0 === r[n]) throw new TypeError('No method named "' + n + '"');
                                r[n]();
                            }
                        });
        ...
        t(document).on(_t.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
            e.preventDefault(), jt._jQueryInterface.call(t(this), "show");
        }),
            (t.fn.tab = jt._jQueryInterface),
            (t.fn.tab.Constructor = jt),
            (t.fn.tab.noConflict = function () {
                return (t.fn.tab = wt), jt._jQueryInterface;
            });
        var St = "toast",
            At = "bs.toast",
            kt = "." + At,
            Ot = t.fn[St],
            Nt = { CLICK_DISMISS: "click.dismiss" + kt, HIDE: "hide" + kt, HIDDEN: "hidden" + kt, SHOW: "show" + kt, SHOWN: "shown" + kt },
            Dt = "show",
            Mt = "showing",
            ...
            Ht = (function () {
                ...
                return (
                    (n.show = function () {
                        ...
                        var n = function () {
                            e._element.classList.remove(Mt), e._element.classList.add(Dt), t(e._element).trigger(Nt.SHOWN), e._config.autohide && e.hide();
                        };
                    ...
                    (n._getConfig = function (e) {
                        return (e = o({}, Lt, t(this._element).data(), "object" == typeof e && e ? e : {})), l.typeCheckConfig(St, e, this.constructor.DefaultType), e;
                    }),
                    ...
                    (e._jQueryInterface = function (n) {
                        return this.each(function () {
                            var i = t(this),
                                r = i.data(At);
                            if ((r || ((r = new e(this, "object" == typeof n && n)), i.data(At, r)), "string" == typeof n)) {
                                if (void 0 === r[n]) throw new TypeError('No method named "' + n + '"');
                                r[n](this);
                            }
                        });
        ...
        (t.fn[St] = Ht._jQueryInterface),
            (t.fn[St].Constructor = Ht),
            (t.fn[St].noConflict = function () {
                return (t.fn[St] = Ot), Ht._jQueryInterface;
            }),
            (function () {
        ...
        return (function () {
        ...
        })()(
            {
                1: [
                    function (e, t, n) {
                        var i = e("./lib/execute-scripts.js"),
                            ...
                            p = e("./lib/util/contains.js"),
                            f = e("./lib/util/extend.js"),
                            h = e("./lib/util/noop"),
                            d = function (e) {
                        ...
                        if (
                            ...
                            (d.prototype = {
                                ...
                                loadContent: function (e, t) {
                                    ...
                                    if (
                                        ...
                                        document.activeElement && p(document, this.options.selectors, document.activeElement))
                                    )
                                        try {
                                ...
                                loadUrl: function (e, t) {
                                    (t = "object" == typeof t ? f({}, this.options, t) : u(this.options)),
                                    ...
                                    if (
                                        (t.options.history &&
                                            (window.history.state ||
                                                ((this.lastUid = this.maxUid = a()), window.history.replaceState({ url: window.location.href, title: document.title, uid: this.maxUid, scrollPos: [0, 0] }, document.title)),
                            ...
                            (d.isSupported = e("./lib/is-supported.js")),
                            d.isSupported())
                        )
                            t.exports = d;
                        else {
                            var y = h;
                            for (var m in d.prototype) d.prototype.hasOwnProperty(m) && "function" == typeof d.prototype[m] && (y[m] = h);
                            t.exports = y;
                        }
                    },
                    {
                ...
                3: [
                    function (e, t, n) {
                        t.exports = function (e) {
                            ...
                            if (((r.type = "text/javascript"), "" !== n && ((r.src = n), (r.async = !1)), "" !== t))
                                try {
                                    r.appendChild(document.createTextNode(t));
                                } catch (e) {
                                    r.text = t;
                                }
                            return i.appendChild(r), (i instanceof HTMLHeadElement || i instanceof HTMLBodyElement) && i.removeChild(r), !0;
                        };
                    },
                    {},
                ],
                    ...
                    function (e, t, n) {
                                ...
                                if (!Number.isNaN(Number(n))) {
                                    ...
                                    if (i.name && void 0 !== i.attributes && "button" !== r) {
                                        ...
                                        if (!o || ("checkbox" !== o.value && "radio" !== o.value) || i.checked) {
                                            var s = [];
                                            if ("select" === r) for (var a, l = 0; l < i.options.length; l++) (a = i.options[l]).selected && s.push(a.value || a.text);
                                            else s.push(i.value);
                                            for (var c = 0; c < s.length; c++) t.push({ name: encodeURIComponent(i.name), value: encodeURIComponent(s[c]) });
                                        }
                                    }
                                }
                            return t;
                        ...
                        function r(e, t) {
                            return e.protocol !== window.location.protocol || e.host !== window.location.host
                                ? "external"
                                : e.hash && e.href.replace(e.hash, "") === window.location.href.replace(location.hash, "")
                                ? "anchor"
                                : e.href === window.location.href.split("#")[0] + "#"
                                ? "anchor-empty"
                                : t.currentUrlFullReload && e.href === window.location.href.split("#")[0]
                                ? "reload"
                                : void 0;
                        }
                        var o = e("../events/on"),
                    ...
                    function (e, t, n) {
                        function i(e, t) {
                            return t.which > 1 || t.metaKey || t.ctrlKey || t.shiftKey || t.altKey
                                ? "modifier"
                                : e.protocol !== window.location.protocol || e.host !== window.location.host
                                ? "external"
                                : e.hash && e.href.replace(e.hash, "") === window.location.href.replace(location.hash, "")
                                ? "anchor"
                                : e.href === window.location.href.split("#")[0] + "#"
                        ...
                        t.exports = function (e, t, n, s) {
                            if (((s = i(s || this.options)), (s.request = t), !1 !== e)) {
                                ...
                                try {
                                    ...
                                    if ((o(document, "pjax:error", s), this.options.debug)) throw e;
                                    return console && console.error && console.error("Pjax switch fail: ", e), this.latestChance(n);
                                }
                            } else o(document, "pjax:complete pjax:error", s);
                        };
                    },
                    { "../events/trigger.js": 5, "../uniqueid.js": 19, "../util/clone.js": 20 },
                ],
                14: [
                    function (e, t, n) {
                        t.exports = function () {
                    ...
                    function (e, t, n) {
                        ...
                        t.exports = function (e, t, n) {
                            var r,
                                ...
                                s = (o.requestMethod || "GET").toUpperCase(),
                ...
                21: [
                    function (e, t, n) {
                        t.exports = function (e, t, n) {
                            for (var i = 0; i < t.length; i++) for (var r = e.querySelectorAll(t[i]), o = 0; o < r.length; o++) if (r[o].contains(n)) return !0;
                            return !1;
                        };
                    },
                    {},
    ...
    (function (e) {
        ...
        e(document).on("pjax:send", function () {
            ...
            e(document).on("refresh", function () {
                i && i.refresh(), n && n.refresh(), r && r.refresh();
            }),
            e(document).on("pjax:success", function () {
                e("body").removeClass("page-loading"),
                    bootstrap && bootstrap.Util
                        ...
                        : (e(document).trigger("pjaxEnd"), e(".js-Pjax-onswitch").removeClass("js-Pjax-onswitch"));
            });
        var t = {
                classNames: { remove: "animate animate-reverse animate-fast animate-no-delay", add: "animate", backward: "fadeInLeft", forward: "fadeInRight" },
                callbacks: {
            ...
            n = new Pjax({ cacheBust: !1, elements: "#header .navbar-navs a:not(.no-ajax)", selectors: ["title", "#main"], switches: { "#main": Pjax.switches.sideBySide }, switchesOptions: { "#main": t } }),
            i = new Pjax({
                cacheBust: !1,
                ...
                switchesOptions: { "#content": t },
            }),
            r = new Pjax({ cacheBust: !1, elements: "#content-aside a, #content-body a", selectors: ["title", "#content-body"], switches: { "#content-body": Pjax.switches.sideBySide }, switchesOptions: { "#content-body": t } });
    })(jQuery);
var MODULE_CONFIG = {
        // chat: ["../libs/list.js/dist/list.js", "../libs/notie/dist/notie.min.js", "../assets/js/plugins/notie.js", "../assets/js/app/chat.js"],
        // mail: ["../libs/list.js/dist/list.js", "../libs/notie/dist/notie.min.js", "../assets/js/plugins/notie.js", "../assets/js/app/mail.js"],
        // user: ["../libs/list.js/dist/list.js", "../libs/notie/dist/notie.min.js", "../assets/js/plugins/notie.js", "../assets/js/app/user.js"],
        // search: ["../libs/list.js/dist/list.js", "../assets/js/app/search.js"],
        // invoice: ["../libs/list.js/dist/list.js", "../libs/notie/dist/notie.min.js", "../assets/js/app/invoice.js"],
        // musicapp: ["../libs/list.js/dist/list.js", "../assets/js/plugins/musicapp.js"],
        ...
        // countTo: ["../libs/jquery-countto/jquery.countTo.js"],
        // stick_in_parent: ["../libs/sticky-kit/dist/sticky-kit.min.js"],
        // stellar: ["../libs/jquery.stellar/jquery.stellar.min.js", "../assets/js/plugins/stellar.js"],
        // masonry: ["../libs/masonry-layout/dist/masonry.pkgd.min.js"],
        // slick: ["../libs/slick-carousel/slick/slick.css", "../libs/slick-carousel/slick/slick-theme.css", "../libs/slick-carousel/slick/slick.min.js"],
        // sort: ["../libs/html5sortable/dist/html.sortable.min.js", "../assets/js/plugins/sort.js"],
        // apexcharts: ["../libs/apexcharts/dist/apexcharts.min.js", "../assets/js/plugins/apexcharts.js"],
        // chartjs: ["../libs/moment/min/moment-with-locales.min.js", "../libs/chart.js/dist/Chart.min.js", "../libs/chart.js/dist/chart.ext.js", "../assets/js/plugins/chartjs.js"],
        // chartist: [
        ...
        // ],
        // dataTable: ["../libs/datatables/media/js/jquery.dataTables.min.js", "../libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js", "../libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css", "../assets/js/plugins/datatable.js"],
        // bootstrapTable: [
        ...
        // typeahead: ["../assets/js/typeahead.bundle.min.js", "../assets/js/typeahead.js"],
        ...
        // daterangepicker: ["../libs/daterangepicker/daterangepicker.css", "../libs/moment/min/moment-with-locales.min.js", "../libs/daterangepicker/daterangepicker.js"],
        // fullCalendar: [
        ...
        // ],
        // parsley: ["../libs/parsleyjs/dist/parsley.min.js"],
        // select2: ["../libs/select2/dist/css/select2.min.css", "../libs/select2/dist/js/select2.min.js", "../assets/js/plugins/select2.js"],
        ...
        // ],
        // plyr: ["../libs/plyrist/src/plyrist.css", "../libs/plyr/dist/plyr.polyfilled.min.js", "../libs/wavesurfer.js/dist/wavesurfer.min.js", "../libs/plyrist/src/plyrist.js", "../assets/js/plugins/plyr.js"],
    },
    MODULE_OPTION_CONFIG = { parsley: { errorClass: "is-invalid", successClass: "is-valid", errorsWrapper: '<ul class="list-unstyled text-sm mt-1 text-muted"></ul>' } },
    lazyload = lazyload || {};
!(function (e, t) {
    "use strict";
    var n = [],
    ...
    (function ($, MODULE_CONFIG, MODULE_OPTION_CONFIG) {
        ...
        $.fn.plugin = function () {
            ...
            return this.each(function () {
                var e = $(this),
                    t = e.find(".loading"),
                    n = e.attr("data-option") || e.attr("data-plugin-option"),
                    i = e.attr("data-plugin");
                e[i] && n
                    ? (e[i].apply(e, getOpts(n, i)), t.remove())
                    : lazyload.load(MODULE_CONFIG[i]).then(function () {
                          n && e[i].apply(e, getOpts(n, i)), e[i] && e[i].init && e[i].init(), window[i] && window[i].init && window[i].init(), t.remove();
                      }),
    ...
    (function () {
        ...
        function e(n) {
            return void 0 === this || Object.getPrototypeOf(this) !== e.prototype
                ...
                : ((T = this),
                  ...
                  (T.tools = new E()),
                  T.isSupported()
                      ? (T.tools.extend(T.defaults, n || {}), (T.defaults.container = t(T.defaults)), (T.store = { elements: {}, containers: [] }), (T.sequences = {}), (T.history = []), (T.uid = 0), (T.initialized = !1))
        ...
        function n(e, t) {
            return "string" == typeof e ? Array.prototype.slice.call(t.querySelectorAll(e)) : T.tools.isNode(e) ? [e] : T.tools.isNodeList(e) ? Array.prototype.slice.call(e) : [];
        }
        function i() {
            return ++T.uid;
        }
        function r(e, t, n) {
            t.container && (t.container = n),
                e.config ? (e.config = T.tools.extendClone(e.config, t)) : (e.config = T.tools.extendClone(T.defaults, t)),
        ...
        function l(e) {
            ...
            t && -1 === T.store.containers.indexOf(t) && T.store.containers.push(e.config.container), (T.store.elements[e.id] = e);
        }
        function c(e, t, n) {
        ...
        function f() {
            var e, t, n, i;
            T.tools.forOwn(T.sequences, function (r) {
                (i = T.sequences[r]), (e = !1);
                for (var o = 0; o < i.elemIds.length; o++) (n = i.elemIds[o]), (t = T.store.elements[n]), _(t) && !e && (e = !0);
                i.active = e;
            });
        }
        function h() {
                    ...
                    (t = T.store.elements[n]),
                        ...
                        m(t)
                            ? (t.config.beforeReveal(t.domEl),
                              ...
                              (t.seen = !0),
                              t.sequence && d(t, e))
                            : v(t) && (t.config.beforeReset(t.domEl), t.domEl.setAttribute("style", t.styles.inline + t.styles.transform.initial + t.styles.transition.instant), y("reset", t), (t.revealing = !1));
                });
        }
        function d(e, t) {
            var n = 0,
        ...
        function m(e) {
            if (e.sequence) {
                var t = T.sequences[e.sequence.id];
        ...
        function g(e) {
            ...
            return "always" === t || ("onload" === t && !T.initialized) || ("once" === t && !e.seen);
        }
        function v(e) {
            return e.sequence ? !T.sequences[e.sequence.id].active && e.config.reset && e.revealing && !e.disabled : !_(e) && e.config.reset && e.revealing && !e.disabled;
        }
        function x(e) {
            ...
            return (
                (function () {
                    var t = a + o * r,
                        ...
                        f = c - o * r,
                        h = u - s * r,
                        d = i.y + e.config.viewOffset.top,
                        y = i.x + e.config.viewOffset.left,
                        m = i.y - e.config.viewOffset.bottom + n.height,
                        g = i.x - e.config.viewOffset.right + n.width;
                    return t < m && f > d && p < g && h > y;
        ...
        (e.prototype.defaults = {
            ...
            (e.prototype.reveal = function (e, s, a, p) {
                var f, h, d, y, m, g;
                if ((void 0 !== s && "number" == typeof s ? ((a = s), (s = {})) : (void 0 !== s && null !== s) || (s = {}), (f = t(s)), !(h = n(e, f)).length)) return T;
                a && "number" == typeof a && ((g = i()), (m = T.sequences[g] = { id: g, interval: a, elemIds: [], active: !1 }));
                for (var v = 0; v < h.length; v++)
                    (y = h[v].getAttribute("data-sr-id")) ? (d = T.store.elements[y]) : (d = { id: i(), domEl: h[v], seen: !1, revealing: !1 }).domEl.setAttribute("data-sr-id", d.id),
                        m && ((d.sequence = { id: m.id, index: m.elemIds.length }), m.elemIds.push(d.id)),
                        r(d, s, f),
                        o(d),
                        l(d),
                        (T.tools.isMobile() && !d.config.mobile) || !T.isSupported()
                            ? (d.domEl.setAttribute("style", d.styles.inline), (d.disabled = !0))
                            : d.revealing || d.domEl.setAttribute("style", d.styles.inline + d.styles.transform.initial);
                return !p && T.isSupported() && (c(e, s, a), T.initTimeout && window.clearTimeout(T.initTimeout), (T.initTimeout = window.setTimeout(u, 0))), T;
            }),
            (e.prototype.sync = function () {
                if (T.history.length && T.isSupported()) {
                    for (var e = 0; e < T.history.length; e++) {
                        var t = T.history[e];
                        T.reveal(t.target, t.config, t.interval, !0);
                    }
                    u();
                }
                return T;
        ...
        return (function (e) {
            ...
            function (e, t, n) {
                ...
                t.default = Object.keys(o.default)
                    .map(function (e) {
                        return new r.default(e, o.default[e], s.default[e]);
                    })
                    .reduce(function (e, t) {
                        return (e[t.name] = t), e;
                    }, {});
            ...
            function (e, t, n) {
                ...
                !(function () {
                    ...
                    var n = (function () {
                        function e() {}
                        function t(e, t) {
                            for (var i = t.length, r = 0; r < i; ++r) n(e, t[r]);
                        }
                        function n(e, n) {
                            if (n) {
                                var o = typeof n;
            ...
            function (e, t, n) {
                ...
                })("versions", []).push({ version: i.version, mode: n(29) ? "pure" : "global", copyright: "© 2018 Denis Pushkarev (zloirock.ru)" });
            },
            function (e, t, n) {
                var i = n(15),
                    r = Math.min;
                ...
                var i = n(1),
                    ...
                    l = function (e, t, n) {
                        var c,
                            ...
                            m = e & l.P,
                            g = e & l.B,
                            v = d ? i : y ? i[t] || (i[t] = {}) : (i[t] || {}).prototype,
                            x = d ? r : r[t] || (r[t] = {}),
                            b = x.prototype || (x.prototype = {});
                        for (c in (d && (n = t), n))
                            (p = ((u = !h && v && void 0 !== v[c]) ? v : n)[c]),
                                (f = g && u ? a(p, i) : m && "function" == typeof p ? a(Function.call, p) : p),
                                v && s(v, c, p, e & l.U),
                                x[c] != p && o(x, c, f),
                                m && b[c] != p && (b[c] = p);
                    };
                ...
                t.default = function () {
                    ...
                    Array.from(t).forEach(function (t) {
                        return (function (e) {
                            ...
                            var a = s.default[i].toSvg(r({}, t, n, { class: (0, o.default)(t.class, n.class) })),
                                        ...
                                        return (
                                            ...
                                            (function (e) {
                                                return Object.keys(e)
                                                    ...
                                                    .join(" ");
                                            })(r({}, this.attrs, e, { class: (0, s.default)(this.attrs.class, e.class) })) +
                                            ">" +
                                            this.contents +
                                            "</svg>"
                                        );
            ...
            function (e, t, n) {
                ...
                var r = i(n(8)),
                    o = i(n(31)),
                    s = i(n(30));
                e.exports = { icons: r.default, toSvg: o.default, replace: s.default };
            },
            function (e, t, n) {
                var i = n(0)("iterator"),
                    r = !1;
                    ...
                    "Array",
                    {
                        from: function (e) {
                            var t,
                                ...
                                g = 0,
                                v = u(f);
                            if ((m && (y = i(y, d > 2 ? arguments[2] : void 0, 2)), void 0 == v || (h == Array && a(v)))) for (n = new h((t = l(f.length))); t > g; g++) c(n, g, m ? y(f[g], g) : f[g]);
                            else for (p = v.call(f), n = new h(); !(r = p.next()).done; g++) c(n, g, m ? s(p, y, [r.value, g], !0) : r.value);
                            return (n.length = g), n;
                        },
                    }
                );
            ...
            function (e, t, n) {
                ...
                e.exports = function (e, t, n, d, y, m, g) {
                    l(n, t, d);
                    var v,
                        x,
                        b,
                        ...
                        S = j || w(y),
                        A = y ? (E ? w("entries") : S) : void 0,
                        k = ("Array" == t && C.entries) || j;
                    if (
                        (k && (b = u(k.call(new e()))) !== Object.prototype && b.next && (c(b, _, !0), i || "function" == typeof b[p] || s(b, p, h)),
                        E &&
                            j &&
                            "values" !== j.name &&
                            ((T = !0),
                        ...
                        if (((v = { values: E ? S : w("values"), keys: m ? S : w("keys"), entries: A }), g)) for (x in v) x in C || o(C, x, v[x]);
                        else r(r.P + r.F * (f || T), t, v);
                    return v;
                };
            },
            function (e, t, n) {
    ...
    (function (e) {
        ...
        function t() {
            var t = e(".setting"),
                ...
                i = e("#header"),
                r = e("#aside");
            n.removeClass(n.attr("data-class")).addClass(theme.setting.bg).attr("data-class", theme.setting.bg),
                i.removeClass(i.attr("data-class")).addClass(theme.setting.header).attr("data-class", theme.setting.header),
                r.removeClass(r.attr("data-class")).addClass(theme.setting.aside).attr("data-class", theme.setting.aside),
                theme.setting.foldedAside ? r.addClass("folded") : r.removeClass("folded"),
                theme.setting.hideAside ? r.addClass("hide") : r.removeClass("hide"),
                theme.setting.stickyHeader ? i.addClass("sticky") : i.removeClass("sticky"),
                theme.setting.stickyAside ? r.addClass("sticky") : r.removeClass("sticky"),
                t.find('input[name="foldedAside"]').prop("checked", theme.setting.foldedAside),
                t.find('input[name="hideAside"]').prop("checked", theme.setting.hideAside),
                t.find('input[name="stickyHeader"]').prop("checked", theme.setting.stickyHeader),
                t.find('input[name="stickyAside"]').prop("checked", theme.setting.stickyAside),
                t.find('input[name="bg"][value="' + theme.setting.bg + '"]').prop("checked", !0);
        }
        function n(e, t) {
            try {
        ...
        (window.theme = {
            color: { primary: "#448bff", info: "#14bae4", success: "#31c971", warning: "#f4c414", danger: "#f54394" },
            setting: { stickyHeader: !0, stickyAside: !0, foldedAside: !1, hideAside: !1, bg: "", header: "bg-body", aside: "bg-light" },
        }),
            (navigator.userAgent.match(/MSIE/i) || navigator.userAgent.match(/Trident.*rv:11\./)) && e("body").addClass("ie");
        var i = window.navigator.userAgent || window.navigator.vendor || window.opera;
        /iPhone|iPod|iPad|Silk|Android|BlackBerry|Opera Mini|IEMobile/.test(i) && e("body").addClass("touch"),
            /iPhone|iPod|iPad/.test(i) &&
                e(document, ".modal, .aside").on("shown.bs.modal", function (t) {
            ...
            e("body").on("DOMMouseScroll mousewheel", function (t) {
                var n = e(".scroll-header");
                t.originalEvent.detail > 0 || t.originalEvent.wheelDelta < 0 ? n.removeClass("scroll-up").addClass("scroll-down") : n.removeClass("scroll-down").addClass("scroll-up"),
                    0 == e(window).scrollTop() && n.removeClass("scroll-up scroll-down");
            }),
            e(".swapimg .handler").on("mousemove", function (t) {
                var n = e(this).parent().offset(),
                    i = Math.round(t.pageX - n.left);
                console.log(i), e(this).parent().width(i);
            }),
            ...
            e(document).on("click", "[data-toggle-class]", function (t) {
                var n = e(this),
                    ...
                    o = n.attr("data-target-closest"),
                    s = (i && i.split(",")) || "",
                    a = (r && r.split(",")) || Array(n),
                    l = 0;
                e.each(s, function (t, i) {
                    var r = o ? n.closest(a[1 == a.length ? 0 : l]) : e(a[1 == a.length ? 0 : l]),
                        c = r.attr("data-class"),
                        u = s[t];
                    c != u && r.removeClass(r.attr("data-class")), r.toggleClass(s[t]), r.attr("data-class", u), l++;
                }),
                    n.toggleClass("active"),
                    "#" == n.attr("href") && t.preventDefault();
            });
        var r = function () {
            e('[data-toggle="popover"]').popover(),
                e('[data-toggle="tooltip"]').tooltip(),
                e(document).find("[data-plugin]").plugin(),
                sr.reveal(
                    ".sr .card, .sr .list-item, .sr .item, .sr .sr-item",
                    {
                        afterReveal: function (t) {
                            e(t).css("transform", "none").css("transition", "none");
                        },
                    },
                    50
                ),
                sr.sync(),
                "undefined" != typeof feather && feather.replace({ width: 16, height: 16 });
            var t = window.location.pathname.split("/");
            t.length > 0 && (t = t[t.length - 1]),
                e("[data-nav]:not(.auto-nav) li.active").removeClass("active"),
                e("[data-nav]:not(.auto-nav) a")
                    .filter(function () {
        ...
        var o = theme.color.primary + "-setting";
        n(o) ? (theme.setting = n(o)) : n(o, theme.setting);
        for (var s = window.location.search.substring(1).split("&"), a = 0; a < s.length; a++) {
            var l = s[a].split("=");
            (theme.setting[l[0]] = "true" == l[1] || "false" == l[1] ? "true" == l[1] : l[1]), n(o, theme.setting);
        }
        e(document).on("click.setting", ".setting input", function (i) {
            var r = e(this),
                s = r.attr("name");
            (theme.setting[s] = r.is(":checkbox") ? r.prop("checked") : e(this).val()), n(o, theme.setting), t(theme.setting);
        }),
            t();
    })(jQuery),
    (function (e) {
        ...
        (e.Utils = {
            ...
            numbers: function (e) {
                var t,
                    ...
                    u = Math.pow(10, l) || 0,
                    p = [];
                for (t = 0; t < a; ++t) (n = (s[t] || 0) + this.rand(r, o)), this.rand() <= c ? p.push(Math.round(u * n) / u) : p.push(null);
                return p;
            },
            labels: function (e) {
                var t,
                    ...
                    l = n.prefix || "",
                    c = [];
                for (t = i; t < r; t += o) c.push(l + Math.round(a * t) / a);
                return c;
            },
            months: function (e) {
                var n,
                    ...
                    s = r.section,
                    a = [];
                for (n = 0; n < o; ++n) (i = t[Math.ceil(n) % 12]), a.push(i.substring(0, s));
                return a;
            },
            color: function (e, t) {
